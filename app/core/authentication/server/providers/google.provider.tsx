...
if (!process.env.SERVER_AUTHENTICATION_GOOGLE_CLIENT_ID || !process.env.SERVER_AUTHENTICATION_GOOGLE_CLIENT_SECRET) {
  throw new Error('Missing required environment variables: SERVER_AUTHENTICATION_GOOGLE_CLIENT_ID and/or SERVER_AUTHENTICATION_GOOGLE_CLIENT_SECRET')
}
class Provider {
  public name = 'google'
